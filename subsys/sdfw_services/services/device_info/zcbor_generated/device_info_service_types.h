...
struct device_info_req {
	union {
		struct read_req device_info_req_msg_read_req_m;
		struct write_req device_info_req_msg_write_req_m;
	};
	enum {
		device_info_req_msg_read_req_m_c,
		device_info_req_msg_write_req_m_c,
	} device_info_req_msg_choice;
};

struct device_info_resp {
	union {
		struct read_resp device_info_resp_msg_read_resp_m;
		struct write_resp device_info_resp_msg_write_resp_m;
	};
	enum {
		device_info_resp_msg_read_resp_m_c,
		device_info_resp_msg_write_resp_m_c,
