		...
		zcbor_state_t *state, const struct device_info_req *input)
{
	...
	&& ((((*input).device_info_req_msg_choice == device_info_req_msg_read_req_m_c) ? ((encode_read_req(state, (&(*input).device_info_req_msg_read_req_m))))
	: (((*input).device_info_req_msg_choice == device_info_req_msg_write_req_m_c) ? ((encode_write_req(state, (&(*input).device_info_req_msg_write_req_m))))
		...
		zcbor_state_t *state, const struct device_info_resp *input)
{
	...
	&& ((((*input).device_info_resp_msg_choice == device_info_resp_msg_read_resp_m_c) ? ((encode_read_resp(state, (&(*input).device_info_resp_msg_read_resp_m))))
	: (((*input).device_info_resp_msg_choice == device_info_resp_msg_write_resp_m_c) ? ((encode_write_resp(state, (&(*input).device_info_resp_msg_write_resp_m))))
